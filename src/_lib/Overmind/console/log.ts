...
export const LOG_VSC_URL_TEMPLATE = (path: string, line: string) =>
  `${LOG_VSC.repo}/blob/${LOG_VSC.revision}/${path}#${line}`
...
export function debug(this: any, thing: { name: string; memory: any; pos: RoomPosition }, ...args: any[]): void {
...
export class Log {
  ...
  public throw(e: Error): void {
    console.log.apply(this, this.buildArguments(FATAL).concat([color(e.toString(), fatalColor)]) as any)
  }

  public error(...args: any[]): undefined {
    if (this.level >= LogLevels.ERROR) {
      console.log.apply(this, this.buildArguments(LogLevels.ERROR).concat([].slice.call(args)) as any)
    }
  ...
  public warning(...args: any[]): undefined {
    if (this.level >= LogLevels.WARNING) {
      console.log.apply(this, this.buildArguments(LogLevels.WARNING).concat([].slice.call(args)) as any)
    }
  ...
  public alert(...args: any[]): undefined {
    if (this.level >= LogLevels.ALERT) {
      console.log.apply(this, this.buildArguments(LogLevels.ALERT).concat([].slice.call(args)) as any)
    }
  ...
  public info(...args: any[]): undefined {
    if (this.level >= LogLevels.INFO) {
      console.log.apply(this, this.buildArguments(LogLevels.INFO).concat([].slice.call(args)) as any)
    }
  ...
  public debug(...args: any[]): void {
    if (this.level >= LogLevels.DEBUG) {
      console.log.apply(this, this.buildArguments(LogLevels.DEBUG).concat([].slice.call(args)) as any)
    }
  }
  ...
  public printObject(obj: any): void {
    console.log.apply(this, this.buildArguments(LogLevels.DEBUG).concat(JSON.stringify(obj)) as any)
  }
